import Garage.sistemaDeGarage.*;
import Garage.vehiculos.*;
import Mundial.*;
...
public class Main {
    public static void main(String[] args) {
        ...
        //Garage
        System.out.println("El Garage abre sus puertas");
        System.out.println("");
        ...
        grupoA.agregarPartidos(new Partido(new Date(3,4,2022),holanda,catar,new Resultado(3,2)));
        ...
        grupoB.agregarPartidos(new Partido(new Date(3,4,2022),inglaterra,iran,new Resultado(6,2)));
        ...
        grupoB.agregarPartidos(new Partido(new Date(3,4,2022),inglaterra,estadosUnidos,new Resultado(6,2)));
        ...
        grupoC.agregarPartidos(new Partido(new Date(3,4,2022),mexico,polonia,new Resultado(4,2)));
        ...
        grupoC.agregarPartidos(new Partido(new Date(3,4,2022),arabiaSaudita,mexico,new Resultado(2,3)));
        ...
        grupoD.agregarPartidos(new Partido(new Date(3,4,2022),francia,australia,new Resultado(5,2)));
        ...
        grupoD.agregarPartidos(new Partido(new Date(3,4,2022),francia,dinamarca,new Resultado(7,2)));
        ...
        grupoD.agregarPartidos(new Partido(new Date(3,4,2022),australia,dinamarca,new Resultado(5,1)));
        ...
        grupoE.agregarPartidos(new Partido(new Date(3,4,2022),españa,costaRica,new Resultado(2,0)));
        ...
        grupoE.agregarPartidos(new Partido(new Date(3,4,2022),japón,costaRica,new Resultado(3,1)));
        ...
        grupoE.agregarPartidos(new Partido(new Date(3,4,2022),españa,alemania,new Resultado(4,2)));
        ...
        grupoE.agregarPartidos(new Partido(new Date(3,4,2022),japón,españa,new Resultado(2,1)));
        ...
        grupoF.agregarPartidos(new Partido(new Date(3,4,2022),marruecos,croacia,new Resultado(3,2)));
        ...
        grupoF.agregarPartidos(new Partido(new Date(3,4,2022),croacia,canadá,new Resultado(3,2)));
        ...
        grupoF.agregarPartidos(new Partido(new Date(3,4,2022),croacia,bélgica,new Resultado(2,0)));
        ...
        grupoG.agregarPartidos(new Partido(new Date(3,4,2022),suiza,camerún,new Resultado(4,2)));
        ...
        grupoG.agregarPartidos(new Partido(new Date(3,4,2022),brasil,serbia,new Resultado(3,2)));
        ...
        grupoG.agregarPartidos(new Partido(new Date(3,4,2022),brasil,suiza,new Resultado(3,1)));
        ...
        grupoH.agregarPartidos(new Partido(new Date(3,4,2022),portugal,ghana,new Resultado(2,1)));
        ...
        grupoH.agregarPartidos(new Partido(new Date(3,4,2022),coreaDelSur,ghana,new Resultado(3,2)));
        ...
        grupoH.agregarPartidos(new Partido(new Date(3,4,2022),portugal,uruguay,new Resultado(3,2)));
        ...
        cuartos.agregarPartidos(new Partido(new Date(3,4,2022),octavos.getEquiposQueAvanzan().get(4),octavos.getEquiposQueAvanzan().get(5),new Resultado(2,5)));
        ...
        semifinal.agregarPartidos(new Partido(new Date(3,4,2022),cuartos.getEquiposQueAvanzan().get(0),cuartos.getEquiposQueAvanzan().get(1),new Resultado(0,3)));
        ...
        finalMundial.agregarPartidos(new Partido(new Date(3,4,2022),semifinal.getEquiposQueAvanzan().get(0),semifinal.getEquiposQueAvanzan().get(1),new Resultado(2,3)));
